/*!
{
  ...
  "date": "2019-08-19T15:56:22.513Z",
  "describe": "",
  "description": "A Javascript assertion library.",
  "file": "assert-x.js",
  "hash": "1e9a6a5f5ed6f45e4861",
  "license": "MIT",
  "version": "3.2.0"
}
*/
...
var isTypedArray = __webpack_require__(9);
...
var keysShim = origKeys ? function keys(o) { return origKeys(o); } : __webpack_require__(30);
...
;(function () {
  ...
  var isLoader =  true && __webpack_require__(35);
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(34)(module), __webpack_require__(7)))
...
var isBigInt = __webpack_require__(6);
...
var hasSymbolSham = __webpack_require__(29);
...
if (!Object.keys) {
	...
	var toStr = Object.prototype.toString;
	var isArgs = __webpack_require__(17); // eslint-disable-line global-require
...
var error_stack_parser = __webpack_require__(23);
...
var is_arguments = __webpack_require__(8);
...
var is_generator_function = __webpack_require__(24);
...
var is_regex = __webpack_require__(10);
...
var is_array_buffer_x_esm_bLength = hasABuf && has_to_string_tag_x_esm ? is_array_buffer_x_esm_getBlength() : null;
/**
...
var is_array_buffer_x_esm_isArrayBuffer = function isArrayBuffer(object) {
  ...
  if (to_boolean_x_esm(is_array_buffer_x_esm_bLength) === false) {
...
var is_map_x_esm_getSize = is_map_x_esm_getGetter();
/**
...
var is_promise = __webpack_require__(14);
...
var array_every_x_esm_test1 = function test1() {
  var spy = 0;
  var res = attempt_x_esm.call([1, 2], nativeEvery, function spyAdd1(item) {
    spy += item;
    return true;
  });
...
var array_every_x_esm_test5 = function test5() {
  ...
  if (doc) {
    ...
    var div = doc.createElement('div');
    fragment.appendChild(div);
    var res = attempt_x_esm.call(fragment.childNodes, nativeEvery, function spyAssign(item) {
      spy = item;
    });
...
var string_includes_x_esm_test1 = function test1() {
  return attempt_x_esm.call('/a/', string_includes_x_esm_nativeIncludes, /a/).threw;
};

var string_includes_x_esm_test2 = function test2() {
  var res = attempt_x_esm.call('abc', string_includes_x_esm_nativeIncludes, 'a', Infinity);
  return res.threw === false && res.value === false;
};

var string_includes_x_esm_test3 = function test3() {
  var res = attempt_x_esm.call(123, string_includes_x_esm_nativeIncludes, '2');
  return res.threw === false && res.value === true;
};

var string_includes_x_esm_test4 = function test4() {
  var res = attempt_x_esm.call(null, string_includes_x_esm_nativeIncludes, 'u');
  return res.threw;
};

var string_includes_x_esm_isWorking = to_boolean_x_esm(string_includes_x_esm_nativeIncludes) && string_includes_x_esm_test1() && string_includes_x_esm_test2() && string_includes_x_esm_test3() && string_includes_x_esm_test4();
...
var ew = string_ends_with_x_esm_ERR_MSG.endsWith,
    string_ends_with_x_esm_charCodeAt = string_ends_with_x_esm_ERR_MSG.charCodeAt;
...
var string_ends_with_x_esm_predicate = function predicate(obj) {
  ...
  while (index < searchLength) {
    if (string_ends_with_x_esm_charCodeAt.call(str, start + index) !== string_ends_with_x_esm_charCodeAt.call(searchStr, index)) {
      return false;
    }
...
var is_boxed_primitive_implementation = __webpack_require__(27);
...
var arraybuffer_equal = __webpack_require__(16);
...
var is_deep_strict_equal_x_esm_ref = [],
    is_deep_strict_equal_x_esm_concat = is_deep_strict_equal_x_esm_ref.concat,
    is_deep_strict_equal_x_esm_push = is_deep_strict_equal_x_esm_ref.push;
/* eslint-disable-next-line no-void */
...
var is_deep_strict_equal_x_esm_getOwnNonIndexProperties = function getOwnNonIndexProperties(value, filter) {
  ...
  return array_filter_x_esm(is_deep_strict_equal_x_esm_concat.call([], names, symbols), function predicate(key) {
    return !is_index_x_esm(key);
  });
};
    ...
    if (symbolKeysA.length !== 0) {
      ...
      for (i = 0; i < symbolKeysA.length; i += 1) {
        ...
        if (property_is_enumerable_x_esm(val1, key)) {
          ...
          is_deep_strict_equal_x_esm_push.call($aKeys, key);
          count += 1;
...
var assert_x_esm_rxTest = simple_methodize_x_esm(/none/.test); // eslint-disable jsdoc/check-param-names
// noinspection JSCommentMatchesSignature
...
var assert_x_esm_baseFail = function baseFail(args) {
  var _args = assert_x_esm_slicedToArray(args, 4),
      actual = _args[0],
      expected = _args[1],
      message = _args[2],
      operator = _args[3];
...
var assert_x_esm_expectedException = function expectedException(actual, expected) {
  ...
  if (is_regexp_x_esm(expected)) {
    return assert_x_esm_rxTest(expected, to_string_symbols_supported_x_esm(actual));
  }
  ...
  if (is_function_x_esm(expected)) {
    return simple_call_x_esm(expected, {}, [actual]) === true;
  }
...
var assert_x_esm_throwerBaseThrows = function throwerBaseThrows(args) {
  var _args2 = assert_x_esm_slicedToArray(args, 4),
...
var assert_x_esm_baseThrows = function baseThrows(args) {
  var _args3 = assert_x_esm_slicedToArray(args, 4),
...
var assert_x_esm_baseAssert = function baseAssert(args) {
  var _args4 = assert_x_esm_slicedToArray(args, 3),
      value = _args4[0],
      message = _args4[1],
      operator = _args4[2];
